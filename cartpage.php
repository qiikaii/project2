    ...
    if ($conn->connect_error) {
        ...
        if ($count < 1) {
            ...
            while ($i != $count) {
                ...
                <p> $itemname ($size) </p>
                <p> Price: $$itemprice</p>
                <label for=\"cartquantity\" Qty: <input type=\"number\" class=\"qtyupdate\" name=\"cartquantity\" id=\"cartquantity\" 
                placeholder=\"$rowquan[$i]\" value=\"$rowquan[$i]\" min=\"1\" max=\"99\" autocomplete=\"off\" 
                    required pattern=\"[0-9]{1,2}\"><\label>
                ...
                placeholder=\"$rowquan[$i]\" value=\"$rowquan[$i]\" size=\"2\" min=\"1\" max=\"99\" autocomplete=\"off\" 
                    required pattern=\"[0-9]{1,2}\"></label>
                <input type=\"submit\" name=\"updatecart\" value=\"Update\"></button>
                </article>
                </section>
