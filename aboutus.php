            ...
            <article class="row">
                <section class="col-sm-6">
                    ...
                    <article class="container" id="mapcontainer">
                        ...
                        <p id="google"></p>
                        <a href="https://goo.gl/maps/VrunxiPVSto7QqYv6" title="Map to Delta's address"><img src="googlemap.PNG" id="gmap" alt=""></a>
                    </article>
                </section>
                <section class="col-sm-6">
                    <h1>CONTACT US</h1>
